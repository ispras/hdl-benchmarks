...
assign
  ...
  R2CVAD1NF = TCOMB_RA2 & (TCOMB_FE & ~UC_17),
  UC_16VZ = ~UC_16VUC_0 | ~UC_16VZVOR1NF,
  C3_Q0VUC_0 = ~C2_CO | ~C3_Q0,
  UC_16VD = ~C2_CO & (~UC_16VZ & ~CLR),
  \[23]  = ~OLATCHVUC_5,
  GRN1 = OLATCH_G1L,
  GRN2 = OLATCH_G2L,
  ...
  TCOMB_RA2VOR2NF = ~OLATCH_FEL | CLR,
  ...
  Y1CVAD1NF = TCOMB_YA1 & (TCOMB_FE & ~UC_17),
  \[36]  = C3_Q3VD,
  ...
  TCOMBVNODE8 = ~TCOMBVNODE8VOR1NF | (~TCOMBVNODE8VOR2NF | (~C3_Q2 | CLR)),
