...
assign
  ...
  ADDVG3VCNVAD4NF = ~AD2N & (~ADDVG2VCN & ~ACVQN2),
  ADDVG4VCNVOR2NF = ~AD3N | (~ADDVG3VCN | ~ACVQN3),
  ...
  ADDVG2VCNVOR2NF = ~AD1N | (~ADDVG1VCN | ~ACVQN1),
  ...
  \[25]  = ~ACVQN3,
  CNTVG1VG2VOR1NF = READYN | CT0,
  ADDVG2VCNVAD1NF = ~AD1N & ~ACVQN1,
  \[26]  = CNTVG3VD,
  CNTVG3VD1 = READYN & ~CNTVCON1,
  ...
  ADDVG2VCNVAD4NF = ~AD1N & (~ADDVG1VCN & ~ACVQN1),
  ...
  ADDVG3VCNVOR2NF = ~AD2N | (~ADDVG2VCN | ~ACVQN2),
  SMVG2VX = ~SMVG2VG1VAD1NF & ~SMVG2VG1VAD2NF,
  AD2N = ~AX2 | MRVQN0,
  ADDVG2VCNVOR1NF = ~AD1N | ~ACVQN1,
  SMVG3VG1VAD2NF = ADSH & ~ADDVG3VSN,
  ...
  ADDVG4VCNVAD4NF = ~AD3N & (~ADDVG3VCN & ~ACVQN3),
  \[17]  = ~READYN,
